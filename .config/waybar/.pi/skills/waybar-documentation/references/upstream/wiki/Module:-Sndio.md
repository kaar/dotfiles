> [!NOTE]
> This page is **auto-generated from [`man/waybar-sndio.5.scd`](https://github.com/Alexays/Waybar/blob/master/man/waybar-sndio.5.scd)** on the `master` branch.
...
| **scroll-step** | int | 5 | The speed at which to change the volume when scrolling. |
| **on-click** | string |  | Command to execute when clicked on the module. This replaces the default behaviour of toggling mute. |
