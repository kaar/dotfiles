> [!NOTE]
> This page is **auto-generated from [`man/waybar-wlr-taskbar.5.scd`](https://github.com/Alexays/Waybar/blob/master/man/waybar-wlr-taskbar.5.scd)** on the `master` branch.
