> [!NOTE]
> This page is **auto-generated from [`man/waybar-clock.5.scd`](https://github.com/Alexays/Waybar/blob/master/man/waybar-clock.5.scd)** on the `master` branch.
...
- **clock**: Full-featured implementation, including the calendar and timezone support described below. Enabled at build time when either C++20 concepts (\_\_cpp_concepts \>= 201907, gcc \>= 13) are available, or the HowardHinnant date library \<https://github.com/HowardHinnant/date\> is installed.
