> [!NOTE]
> This page is **auto-generated from [`man/waybar-power-profiles-daemon.5.scd`](https://github.com/Alexays/Waybar/blob/master/man/waybar-power-profiles-daemon.5.scd)** on the `master` branch.
